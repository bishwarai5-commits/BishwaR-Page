...
<div style="background-color: rgba(255, 255, 255, 0.6); padding: 25px; border-radius: 12px; margin-bottom: 40px; box-shadow: 0 8px 20px rgba(3,105,161,0.05); border: 1px solid rgba(255,255,255,0.4);">
  ...
  <div style="margin-bottom: 15px;">
    <span style="font-weight: 700; color: #0c4a6e; font-size: 14px; display: block; margin-bottom: 5px;">🛠️ Technical Toolkit:</span>
    <div style="display: flex; flex-wrap: wrap; gap: 6px;">
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">SQL</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">Microsoft Fabric</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">Power BI</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">DOMO</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">Tableau</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">R</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">Python</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">Claude Code</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">Machine Learning</span>
      <span style="background-color: #0369a1; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600;">Data Mining</span>
  ...
  <div>
    <span style="font-weight: 700; color: #0c4a6e; font-size: 14px; display: block; margin-bottom: 5px;">🏃‍♂️ Beyond the Desk:</span>
    <div style="display: flex; flex-wrap: wrap; gap: 6px;">
      <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Marathon Running</span>
      <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Swimming</span>
      <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Competitive Target Shooting</span>
      <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Hiking & Camping</span>
      <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Skydiving</span>
      <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Public Speaking</span>
      <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Writing</span>
         <span style="background-color: rgba(3, 105, 161, 0.1); color: #0369a1; padding: 3px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid rgba(3, 105, 161, 0.2);">Learning New Languages</span>
    </div>
  </div>
</div>
...
<hr style="border: 0; height: 1px; background-image: linear-gradient(to right, rgba(3,105,161,0), rgba(3,105,161,0.2), rgba(3,105,161,0)); margin-top: 40px;">

<div align="center" style="margin-top: 25px;">
  <p style="font-size: 13px; color: #0c4a6e; font-weight: 500;">Follow this page to stay updated on my latest technical insights.</p>
</div>
